...
export default function InfoBoxExp(props) {
  ...
  return (
    <div className="info-box-container">
      <div className="box-title-container">Experiance</div>
      {userInfo && (
        <div className="box-main">
          {userInfo.user_info.experiences
            ? userInfo.user_info.experiences.map((item, index) => {
                return (
